                                ...
                                {showAccommodation.length >0 ? showAccommodation.map((accommodation)=>(
                                    <div onClick={(e)=>showPopup(e,accommodation)} key={accommodation.id} className={styles['accommodation-item']} >
                                        ...
                                        {<div className={styles['price-box']} >
                                           ...
                                           {accommodation.min_price  && accommodation.max_price   ? <span>
                                               {`${parseInt(accommodation.min_price) >= parseInt(accommodation.max_price) ? `${accommodation.min_price} บาท` :`${accommodation.min_price} - ${accommodation.max_price} บาท` }`}</span> :''}
                                        </div>}
                                    </div>
                                )):''}
                            </div>
