...
export default function index() {
  ...
  const getAccommodation =async()=>{
    let accommodation_data = await axios.get('/get/accommodation')
  ...
  const getProduct=async()=>{
    let product_data = await axios.get('/get/products')
    console.log('product is',product_data.data.payload);
    setProducts(product_data.data.payload)
  }
  const getRestaurant=async()=>{
    let restaurant_data = await axios.get('/get/restaurant')
  ...
  const getReview=async()=>{
    let review_data = await axios.get('/get/reviews')
